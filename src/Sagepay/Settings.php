...
class Settings {
    ...
    static public function getInstance(array $config = array(), $loadFileConfig = true)
    {
        ...
        {
            self::$_instance = new Settings($config, $loadFileConfig);
        }
    ...
    {
        if (!empty($website) && Valid::url($website))
        {
    ...
    /**
     * Insert values of array config into current instance Config
     *
     * @param array $config
     */
