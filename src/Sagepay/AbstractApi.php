...
abstract class AbstractApi
{
     ...
     * @param Basket $basket
     */
    public final function setBasket(Basket $basket)
    {
        $this->basket = $basket;
    }
     ...
     * Set addressList
     *
     * @param CustomerDetails[] $addressList
     */
     ...
     *
     * @param CustomerDetails $address
     */
    public final function addAddress(CustomerDetails $address)
    {
    ...
    protected function checkMandatoryFields()
    {
        ...
        if (count($emptyFields))
        {
            ...
            throw new ApiException($fields . ' ' . $beVerb . " empty");
        }
        $this->sortData();
    }
